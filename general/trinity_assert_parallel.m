...
%             'Parallelization is not tested for Windows.') % TODO
        ...
        if ~havepct
            error('trinity:trinity_assert_parallel:pctnotfound', ...
    ...
    case {'GLNX86', 'GLNXA64'}
        if ~test_parallel()
            ...
            error('trinity:trinity_assert_parallel:gnuparallelnotfound', ...
    ...
    otherwise
        error('trinity:trinity_assert_parallel:unknownArch', ...
