...
%
%   See also: JAGS2CODA, STAN2CODA, READCODA.
% 
...
elseif iscell(options)
    ...
    trinity.error_tag('trinity:bugs2coda:badInput', ['BUGS2CODA accepts as input either an' ...
        ' options structure or a cell list of coda file names.'])
end

out = trinity.readcoda(workingdir, coda_files, verbosity);
