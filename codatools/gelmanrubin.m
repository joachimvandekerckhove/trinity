...
if niter < 50
    if niter < 1
        trinity.error_tag('trinity:gelmanrubin:noSamples',...
...
if nargin < 4
    if nargout < 6
        ...
        trinity.error_tag('trinity:gelmanrubin:tooManyOutputs',...
            'Too many output arguments.')
    end
elseif nargout < 2
    varargout = {eval(lower(specvar))};
else
    trinity.error_tag('trinity:gelmanrubin:inconsistentRequest',...
